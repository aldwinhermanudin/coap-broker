...
#define NAMABINTANG "Adika Bintang Sulaeman"

static void hnd_get_bintang(coap_context_t *ctx UNUSED_PARAM,
	...
	coap_add_data(response, strlen(NAMABINTANG), (unsigned char *)NAMABINTANG);
}

static void hnd_get_pressure(coap_context_t *ctx UNUSED_PARAM,
              struct coap_resource_t *resource UNUSED_PARAM,
              const coap_endpoint_t *local_interface UNUSED_PARAM,
              coap_address_t *peer UNUSED_PARAM,
              coap_pdu_t *request UNUSED_PARAM,
	...
	x = 4 * 5;
	sprintf(buf, "%d", x);
	coap_add_data(response, strlen(buf), (unsigned char *)buf);
}
...
hnd_get_time(coap_context_t  *ctx,
  ...
  coap_tick_t t;
	...
	printf("handler get time kepanggil\n");
...
static void
hnd_put_tes(coap_context_t *ctx UNUSED_PARAM,
             struct coap_resource_t *resource UNUSED_PARAM,
             const coap_endpoint_t *local_interface UNUSED_PARAM,
             coap_address_t *peer UNUSED_PARAM,
             coap_pdu_t *request,
...
init_resources(coap_context_t *ctx) {
  ...
  //nambahin bintang
  r = coap_resource_init((unsigned char *)"bintang", 7, 0);
  coap_register_handler(r, COAP_REQUEST_GET, hnd_get_bintang);
  coap_add_attr(r, (unsigned char *)"ct", 2, (unsigned char *)"0", 1, 0);
  coap_add_attr(r, (unsigned char *)"title", 5, (unsigned char *)"\"Nama Bintang\"", 14, 0);
  coap_add_resource(ctx, r);
  
  r = coap_resource_init((unsigned char *)"pressure", strlen("pressure"), 0);
  coap_register_handler(r, COAP_REQUEST_GET, hnd_get_pressure);
  coap_add_attr(r, (unsigned char *)"ct", 2, (unsigned char *)"50", 1, 0);
  coap_add_attr(r, (unsigned char *)"title", 5, (unsigned char *)"\"Get Sensor Pressure\"", 14, 0);
  coap_add_resource(ctx, r);
  //end of nambahin bintang
